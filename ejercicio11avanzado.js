...
function averageMovieDuration(movies) {
  let promedioDurationFilms = 0;
  for (let movie of movies) {
    promedioDurationFilms = promedioDurationFilms + movie.duration;
  }
  promedioDurationFilms = promedioDurationFilms / movies.length;
  return promedioDurationFilms;
}
