...
function toFilterLongRockSongs(playslist) {
  ...
  console.log(
    "Lista de canciones de Rock de más de 5 minutos de duración",
    rockPlaylist
  );
  console.log("Resto de canciones", otherSongs);
}

toFilterLongRockSongs(songs);
